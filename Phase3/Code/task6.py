...
def outputFrame(videoIndex, frameIndex):
    ...
    Frame = imageio.get_reader(INPUT_VIDEO_PREFIX + fileIn[int(videoIndex)], 'ffmpeg')
    writer = imageio.get_writer(OUTPUT_FRAMES_PREFIX + str(videoIndex) + str(frameIndex) + '.jpg')
